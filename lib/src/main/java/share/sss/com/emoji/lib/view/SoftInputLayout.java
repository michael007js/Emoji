package share.sss.com.emoji.lib.view;
...
public class SoftInputLayout extends ViewGroup {
     ...
     * 监听回调容器
     */
    private HashSet<OnEmojiLayoutChangeListener> mEmojiLayoutChangeListeners = new HashSet<>();
    /**
     * 内边距
     */
    ...
    private void animToShow(int height, int oldHeight) {
        ...
        mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                showEmojiHeight = (Integer) animation.getAnimatedValue();
                postInvalidate();
            }
        });
